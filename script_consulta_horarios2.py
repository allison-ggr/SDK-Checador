...
json='['
#ip=args.ip
zk = ZK("192.168.1.201", port=4370, timeout=5, password=0, force_udp=False, ommit_ping=False)   #Reemplazo de la ip y los parametros de la conexión

try:
    #print ('Connecting to device ...')
    connn = zk.connect() #Conexión con el dispositivo y mensaje de confirmación
   
    #print ('Disabling device ...')
    connn.disable_device() #Dehabilitar el dispositivo y mensaje de confirmación 
    ...
    attendances = connn.get_attendance() #Conección a las clases de Huellas
    ...
    connn.enable_device()            #Rehabilitación del dispositivo y mensaje de confirmación
    ...
    if connn:
        connn.disconnect()      #Desconexión del
